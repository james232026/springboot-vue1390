    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="物资介绍" prop="wuzijieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wuzijieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wuzijieshao" label="物资介绍" prop="wuzijieshao">
                    <span v-html="ruleForm.wuzijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongyingshang = true;
          ...
          if(o=='wuzijieshao'){
            this.ruleForm.wuzijieshao = obj[o];
	    this.ro.wuzijieshao = true;
            continue;
          }
          if(o=='wuzitupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/gongyingshangxinxi/gongyingshangmingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.wuzijieshao = this.ruleForm.wuzijieshao.replace(reg,'../../../springboot4n9r4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
