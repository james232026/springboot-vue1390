<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="购车方式" prop="gouchefangshi">
          <el-select :disabled="ro.gouchefangshi" v-model="ruleForm.gouchefangshi" placeholder="请选择购车方式">
            <el-option
                v-for="(item,index) in gouchefangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="购车方式" prop="gouchefangshi">
	      <el-input v-model="ruleForm.gouchefangshi"
                placeholder="购车方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="交车时间" prop="jiaocheshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiaocheshijian" 
                type="date"
                :readonly="ro.jiaocheshijian"
                placeholder="交车时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiaocheshijian" label="交车时间" prop="jiaocheshijian">
              <el-input v-model="ruleForm.jiaocheshijian" 
                placeholder="交车时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保险年限" prop="baoxiannianxian">
          <el-input v-model="ruleForm.baoxiannianxian" 
              placeholder="保险年限" clearable  :readonly="ro.baoxiannianxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保险年限" prop="baoxiannianxian">
              <el-input v-model="ruleForm.baoxiannianxian" 
                placeholder="保险年限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="维修记录" prop="weixiujilu">
                <el-input
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="保养记录" prop="baoyangjilu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="保养记录"
                  v-model="ruleForm.baoyangjilu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baoyangjilu" label="保养记录" prop="baoyangjilu">
                    <span>{{ruleForm.baoyangjilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	gouchefangshi : false,
	jiaocheshijian : false,
	baoxiannianxian : false,
	weixiujilu : false,
	baoyangjilu : false,
      },
      ruleForm: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheliangpinpai = true;
          ...
          if(o=='gouchefangshi'){
            this.ruleForm.gouchefangshi = obj[o];
	    this.ro.gouchefangshi = true;
            continue;
          }
          if(o=='jiaocheshijian'){
            this.ruleForm.jiaocheshijian = obj[o];
	    this.ro.jiaocheshijian = true;
            continue;
          }
          if(o=='baoxiannianxian'){
            this.ruleForm.baoxiannianxian = obj[o];
	    this.ro.baoxiannianxian = true;
            continue;
          }
          if(o=='weixiujilu'){
	    ...
	    this.ro.weixiujilu = true;
          ...
          if(o=='baoyangjilu'){
            this.ruleForm.baoyangjilu = obj[o];
	    this.ro.baoyangjilu = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.gouchefangshiOptions = "分期,全款".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
