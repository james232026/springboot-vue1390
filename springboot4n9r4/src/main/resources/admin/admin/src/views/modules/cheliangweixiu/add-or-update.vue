<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维修车辆" prop="weixiucheliang">
          <el-input v-model="ruleForm.weixiucheliang" 
              placeholder="维修车辆" clearable  :readonly="ro.weixiucheliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修车辆" prop="weixiucheliang">
              <el-input v-model="ruleForm.weixiucheliang" 
                placeholder="维修车辆" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="耗材" prop="haocai">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="耗材"
                  v-model="ruleForm.haocai" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.haocai" label="耗材" prop="haocai">
                    <span>{{ruleForm.haocai}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weixiudanhao = true;
          ...
          if(o=='weixiucheliang'){
            this.ruleForm.weixiucheliang = obj[o];
	    this.ro.weixiucheliang = true;
            continue;
          }
          if(o=='kehuxingming'){
      ...
      this.$http({
		...
		if(json.weixiuxingming!=''&&json.weixiuxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.weixiuzhuangtaiOptions = "待维修,维修中,完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
